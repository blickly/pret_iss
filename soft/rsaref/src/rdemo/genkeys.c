...
static void WriteKeypair3 PROTO_LIST (());
...
/*   } */
  if ( fileNum < 10 ) {
    filename[8] = ('0' + fileNum);
    filename[9] = 0;
  }
  else if (fileNum < 20 ){
    filename[8] = '1';
    filename[9] = ('0' + (fileNum-10));
    filename[10] = 0;
  }
  else if (fileNum < 30 ){
    filename[8] = '2';
    filename[9] = ('0' + (fileNum-20));
    filename[10] = 0;
  }
  else if (fileNum < 40 ){
    filename[8] = '3';
    filename[9] = ('0' + (fileNum-30));
    filename[10] = 0;
  }
  else if (fileNum < 50 ){
    filename[8] = '4';
    filename[9] = ('0' + (fileNum-40));
    filename[10] = 0;
  }
  ...
  fprintf(file, "static R_RSA_PUBLIC_KEY PUBLIC_KEY4 = {\n");
  ...
  //  fprintf (file, "\nPrivate Key, %u bits:\n", PRIVATE_KEY3.bits);
  fprintf(file, "static R_RSA_PRIVATE_KEY PRIVATE_KEY4 = {\n");
  //  fprintf (file, "  modulus: {");
  fprintf (file, "\t%u,\n\t", PUBLIC_KEY3.bits);
