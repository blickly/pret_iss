...
all mems here are SPM accesses which take 0 time.
mem = 120 TIL cycles; (1+9) + (1+8)x4 + (1+ 21 + 8) = 76 cycles

infinite loop
---------------
to sync: (18)
(48) + (4 mem [2 st], 14 ) = 48 + (2 + 2x21 + 15) = 48 + 59 = 107  
-> no FD : 16
(46) + (2mem [1 st], 14) = 46 + (1 + 21 + 14) = 82
...
---------------
loop to sync: (15)
(4 mem [2 st], 11 sing) = (2 + 2x21 + 11) = 55

-> no FD : 13
(2mem [1 ld], 11) = (1 + 21 + 11) = 33
