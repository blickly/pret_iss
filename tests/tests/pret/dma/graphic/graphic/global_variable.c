...
volatile BOOL * _is_refreshing = (BOOL*) 0x90000000;
...
volatile struct Graphic_layer * _graphic_layer = (struct Graphic_layer*) 0x91000000;
...
BOOL * _is_flushing_recv_command = (BOOL*) 0x93000008;
...
struct Graphic_command_list ** _p_command_queue_front = (struct Graphic_command_list**) 0x9300000C;
struct Graphic_command_list ** _p_command_queue_end = (struct Graphic_command_list**) 0x93000100;
struct Graphic_command_list * _command_queue = (struct Graphic_command_list*) 0x93000200;
